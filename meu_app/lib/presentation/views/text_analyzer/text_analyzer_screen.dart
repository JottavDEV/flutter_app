...
class _TextAnalyzerScreenState extends State<TextAnalyzerScreen> {
  ...
  void initState() {
    ...
    _textController.addListener(() {
      ...
      // Adicionado para que o botão de limpar apareça/desapareça
        ...
        actions: [
          ...
          if (_textController.text.isNotEmpty)
            IconButton(
              ...
              // O onPressed agora é 'async' e chama o diálogo.
              onPressed: () async {
                // Chama a função do diálogo e espera a resposta do usuário
                final bool? confirmClear = await _showClearConfirmationDialog();

                // Só limpa o texto se o usuário confirmou (retornou true)
